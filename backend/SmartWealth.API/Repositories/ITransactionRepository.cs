...
public interface ITransactionRepository
{
    ...
    Task<(IEnumerable<TransactionDto> Items, int TotalCount)> GetPagedAsync(int userId, int page, int pageSize, string? type, int? categoryId, bool weekOnly, string? search);
